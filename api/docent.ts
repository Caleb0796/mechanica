import astroclockDataJson from "../src/data/machines/astroclock.json" with { type: "json" };
import loomDataJson from "../src/data/machines/loom.json" with { type: "json" };
import odometerDataJson from "../src/data/machines/odometer.json" with { type: "json" };
import seismoscopeDataJson from "../src/data/machines/seismoscope.json" with { type: "json" };
import astroclockPartsJson from "../src/machines/astroclock/parts.json" with { type: "json" };
import loomPartsJson from "../src/machines/loom/parts.json" with { type: "json" };
import odometerPartsJson from "../src/machines/odometer/parts.json" with { type: "json" };
import seismoscopePartsJson from "../src/machines/seismoscope/parts.json" with { type: "json" };
import astroclockCombridgeJson from "../src/machines/astroclock/schemes/combridge-hinged.json" with { type: "json" };
import astroclockFixedScoopJson from "../src/machines/astroclock/schemes/fixed-scoop.json" with { type: "json" };
import loomLinkageJson from "../src/machines/loom/schemes/linkage.json" with { type: "json" };
import loomSlidingFrameJson from "../src/machines/loom/schemes/sliding-frame.json" with { type: "json" };
import odometerLuDaolongJson from "../src/machines/odometer/schemes/ludaolong.json" with { type: "json" };
import seismoscopeFengJson from "../src/machines/seismoscope/schemes/fengrui.json" with { type: "json" };
import seismoscopeWangJson from "../src/machines/seismoscope/schemes/wangzhenduo.json" with { type: "json" };
